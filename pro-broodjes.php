...
$catIds = [3, 4, 7, 9, 11]; // bruine broodjes, buitenlandse broodjes, krentenbollen, speciale broodjes, witte broodjes
$in     = implode(',', $catIds);
...
<main>
    <section class="page-hero section-border">
        <div class="container page-hero-inner">
            <p class="eyebrow">Broodjes &amp; Bollen</p>
            <h1>Vers uit de oven</h1>
            <p class="intro-text">Knapperige witte bolletjes, zachte bruine broodjes, zoete krentenbollen en bijzondere varianten — perfect voor lunch of een uitje.</p>
        </div>
    </section>
